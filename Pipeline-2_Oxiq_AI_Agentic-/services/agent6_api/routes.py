...
from services.agent6_api.dependencies import get_agent6
...
def get_health():
    """
    Health check endpoint. Returns operational status without triggering Agent 6.
    """
    return {
        "status": "healthy",
        "service": "agent6",
...
def execute_agent(
    ...
    agent: InterviewInvitationAgent = Depends(get_agent6)
) -> AgentResponse:
    """
    Executes the scheduling logic loop inside the reference Agent 6.
