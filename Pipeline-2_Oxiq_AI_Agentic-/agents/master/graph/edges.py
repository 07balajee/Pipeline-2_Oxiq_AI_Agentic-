...
def route_decision_edge(state: MasterGraphState, config: RunnableConfig) -> str:
    ...
    if next_state and approval_engine.should_pause_for_approval(context.current_state, next_state, context):
        ...
        elif context.current_state == "HRInterviewPending" and next_state == "HREvaluationAwaited":
            approval_type = "HREvaluationApproval"
        elif context.current_state == "HRRankingPending" and next_state == "CandidateRankingAwaited":
